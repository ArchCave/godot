...
/** @type {string} */
const CACHE_VERSION = '1770861019|276286152';
/** @type {string} */
const CACHE_PREFIX = '1intro0209-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'fly.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["fly.html","fly.js","fly.offline.html","fly.icon.png","fly.apple-touch-icon.png","fly.audio.worklet.js","fly.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["fly.wasm","fly.pck"];
